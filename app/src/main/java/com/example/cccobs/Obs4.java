...
public class Obs4 extends AppCompatActivity implements View.OnClickListener {
    Intent intent;
    TextView editStatus;
    TextView counter;
    Button GOTO1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obs4);
    ...
    private void   addItemToSheet() {
        ...
        final String name4 = editStatus.getText().toString();


        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbz8HEUPvOl46mzZpAPGHrow6mt69nB0OOWw05Xc6jRnt4UuNSnZG2PE8AtwSSnXSoxfBg/exec",
    ...
    public void onClick(View v) {
        ...
        if(v == Enter){
            ...
            intent = new Intent(Obs4.this, MainActivity.class);
