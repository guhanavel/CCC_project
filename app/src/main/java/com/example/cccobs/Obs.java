...
public class Obs extends AppCompatActivity implements View.OnClickListener {
    Intent intent;
    TextView editStatus;
    TextView counter;
    Button GOTO1;
    ...
    private void   addItemToSheet() {
        ...
        final String name = editStatus.getText().toString();


        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbz4ydBVmXoAXo2hP4s4GBEh3V1n8rRT4FRScPskAWRzKy9uwoPTlVEUqvpLoSju3WiQ/exec",
    ...
    public void onClick(View v) {
        ...
        if(v == Enter){
            ...
            intent = new Intent(Obs.this, MainActivity.class);
