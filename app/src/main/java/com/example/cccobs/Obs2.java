...
public class Obs2 extends AppCompatActivity implements View.OnClickListener {
    Intent intent;
    TextView editStatus;
    TextView counter;
    Button GOTO1;
    ...
    private void   addItemToSheet() {
        ...
        final String name2 = editStatus.getText().toString();


        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycby-wvJfzoMBSDVFevmmBEeANK86hBbhRneMuIjFmPfKOH9vlwWO7_xYNGpPWBg-4ziZ/exec",
    ...
    public void onClick(View v) {
        ...
        if(v == Enter){
            ...
            intent = new Intent(Obs2.this, MainActivity.class);
