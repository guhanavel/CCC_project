...
public class Obs5 extends AppCompatActivity implements View.OnClickListener {
    Intent intent;
    TextView editStatus;
    TextView counter;
    Button GOTO1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obs5);
    ...
    private void   addItemToSheet() {
        ...
        final String name5 = editStatus.getText().toString();


        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbyIttCRKjhvvw8l0y2u3O_b5X2o64BxuO-c50NRpNwIYZaxh1Qv_vhIPa3281vLiME_/exec",
    ...
    public void onClick(View v) {
        ...
        if(v == Enter){
            ...
            intent = new Intent(Obs5.this, MainActivity.class);
