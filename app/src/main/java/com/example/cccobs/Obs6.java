...
public class Obs6 extends AppCompatActivity implements View.OnClickListener {
    Intent intent;
    TextView editStatus;
    TextView counter;
    Button GOTO1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obs6);
    ...
    private void   addItemToSheet() {
        ...
        final String name6 = editStatus.getText().toString();


        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbzXkZw1cc2IqH3IKrwHN6qdAa2AMuZ1crRGPhERhGj2S0iST3NevCN3qzqNQ_HOpOVTrA/exec",
    ...
    public void onClick(View v) {
        ...
        if(v == Enter){
            ...
            intent = new Intent(Obs6.this, MainActivity.class);
