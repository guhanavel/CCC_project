...
public class Obs7 extends AppCompatActivity implements View.OnClickListener {
    Intent intent;
    TextView editStatus;
    TextView counter;
    Button GOTO1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obs7);
    ...
    private void   addItemToSheet() {
        ...
        final String name7 = editStatus.getText().toString();


        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbwBgCL9cNy0NekqMtK9aNJOW4GxAhs5yj46ty1YVOZWwiUUoL8UpBTL5WVCnWI9_nHr/exec",
    ...
    public void onClick(View v) {
        ...
        if(v == Enter){
            ...
            intent = new Intent(Obs7.this, MainActivity.class);
